...
export default function Navigation() {
  ...
  // Handles opening the menu when avatar is hovered
  const handleMouseEnter = (event) => {
    setAnchorEl(event.currentTarget);
  };

  // Handles closing the menu when mouse leaves
  ...
  const handleMenuItemClick = (action) => {
    ...
    setAnchorEl(null); // Optionally close the menu when an item is clicked
  };
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  ...
                  >
                    <Stack direction="row" spacing={2}>
                      ...
                      <Menu
                        anchorEl={anchorEl}
                        open={Boolean(anchorEl)} // The Menu will be open when anchorEl is not null
