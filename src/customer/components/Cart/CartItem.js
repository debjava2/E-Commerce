...
const CartItem = () => {
  return (
    ...
    <div className='flex items-center'>
        ...
        <img src="https://rukminim1.flixcart.com/image/612/612/xif0q/jean/h/y/g/34-jeans-bt008-laheja-original-imagqqbsfgmdhcvn.jpeg?q=70" alt="" 
        className='w-full h-full object-cover object-top' />
        </div>
        <div className='ml-5 space-y-1'>
            <p className='font-semibold'> Men Slim Mid Rise Balck Jeans</p>
            <p className='text-left opacity-70'>Size L, White</p>
            <p className='opacity-70 mt-2 text-left'>Seller:  Cristtaliyo 2fashion</p>
