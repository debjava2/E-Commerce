  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
            ...
            <div className="flex flex-wrap space-x-5 justify-center">

              {
                product.images.map((item) => (
                  <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[5.5rem]">
                     <img
                alt={item.alt}
                src={item.src}
          ...
          <div className="lg-col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 text-left">
              ...
              <h1 className="text-lg lg-text-xl text-gray-900 opacity-60">Causual Puff Sleeves Solid Women White Top</h1>
            </div>
             ...
             <div className="flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6">
              ...
              <div className="mt-6">
               <div className="flex items-center space-x-3">
                <Rating name="read-only" value={3.3} readOnly size="small" />
                <p className="opacity-60 text-sm">56505 Ratings</p>
              ...
              <form className="mt-10">
                ...
                <div className="flex justify-start p-2">
                      <Button  onClick={()=>handleAddtoCart()} variant="contained" color="secondary" sx={{px:"2rem",py:"1rem"}}>
                        Add To Cart
                      </Button>
                      </div>
              </form>
        ...
        {/* Rating and Review   */}
        <section>
          <h1 className="font-semibold text-lg pb-4 text-left">Recent Reviews and Ratings</h1>
          <div className="border p-5">
                    <Grid container spacing={7}>
                      ...
                      <Grid item xs={5}>
                    <h1 className="text-xl font-semibold pb-2 text-left">Product Rating</h1>
                    <div className="flex items-center space-x-3">
                      <Rating name="half-rating-read" value={4.5} precision={0.5} readOnly />
                      <p className="op">54890 Ratings</p>
                    </div>
        ...
        <h1 className="text-left py-5 text-xl fonr-semibold">Similar Products</h1>
