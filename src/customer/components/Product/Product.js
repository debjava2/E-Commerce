...
export default function Product() {
  ...
  const handleFilters = (value, sectionId) => {
    ...
    if (filterValue.includes(value)) {
      ...
      if (filterValue.length === 0) {
        searchParams.delete(sectionId); // Remove the filter completely if empty
      } else {
        searchParams.set(sectionId, filterValue.join(","));
      }
    } else {
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                <h1 className="text-1g opacity-50 font-bold text-left">Filters</h1>
                <FilterListIcon/>
                </div>
                          ...
                          >
                            {section.options.map((option, optionIdx) => (
                              <FormControlLabel
                                ...
                                control={<Radio />}
                                label={option.label}
                                onChange={(event)=>handleRadioChange(section.id,event)}
                              />
                            ))}
                          </RadioGroup>
                        </div>
              ...
              <div className="lg:col-span-3 w-full">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 bg-white py-5">
